...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		// materialize js
		wp_register_script( 'materialize-js', get_stylesheet_directory_uri() . '/library/js/libs/materialize.min.js', array( 'jquery' ), '', true );
		...
		if($env == $_prodState) {
				...
				$toEnqueue = [];
				if($slugTemplate) {
						$filename = '/library/css/min/'.$slugTemplate.'.min.css';
				...
				$toEnqueue = [];
				if($slugTemplate) {
						$filename = '/library/css/'.$slugTemplate.'.css';
						if(file_exists(get_template_directory() . $filename)) {
							array_push($toEnqueue, 'template-'.$slugTemplate );
							wp_register_style( 'template-'.$slugTemplate , get_stylesheet_directory_uri() . $filename, array(), '' );
						}
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/dist/scripts.bundle.js', array( 'jquery' ), '', true );
